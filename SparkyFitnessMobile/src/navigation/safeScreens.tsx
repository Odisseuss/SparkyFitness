...
import ProgressPhotosCompareScreen from '../screens/ProgressPhotosCompareScreen';
...
export const SafeCheckIn = withErrorBoundary(CheckInScreen, 'MeasurementsAdd', { canGoBack: true });
export const SafeProgressPhotosCompare = withErrorBoundary(ProgressPhotosCompareScreen, 'ProgressPhotosCompare', { canGoBack: true });
